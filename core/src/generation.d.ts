...
import { type Content, type IAgentRuntime, ModelClass, ModelProviderName, type ActionResponse, type IVerifiableInferenceAdapter, type VerifiableInferenceOptions, type TelemetrySettings } from "./types.ts";
 ...
 */
export declare function trimTokens(context: string, maxTokens: number, runtime: IAgentRuntime): Promise<any>;
/**
 ...
 */
export declare function generateText({ runtime, context, modelClass, tools, onStepFinish, maxSteps, stop, customSystemPrompt, verifiableInference, verifiableInferenceOptions, }: {
 ...
 */
export declare const generateObject: ({ runtime, context, modelClass, schema, schemaName, schemaDescription, stop, mode, verifiableInference, verifiableInferenceAdapter, verifiableInferenceOptions, }: GenerationOptions) => Promise<GenerateObjectResult<unknown>>;
/**
