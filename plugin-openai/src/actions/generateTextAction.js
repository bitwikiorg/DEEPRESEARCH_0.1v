...
export const generateTextAction = {
    ...
    async handler(_runtime, message, _state) {
        ...
        const requestData = buildRequestData(String(message.content.model), prompt, typeof message.content.maxTokens === 'number' ? message.content.maxTokens : undefined, typeof message.content.temperature === 'number' ? message.content.temperature : undefined);
